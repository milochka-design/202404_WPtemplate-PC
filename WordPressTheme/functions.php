...
function my_script_init()
{
	...
	wp_enqueue_style('my', get_template_directory_uri() . '/assets/css/styles.css', array(), date('ymdHi', filemtime(get_stylesheet_directory() . '/assets/css/styles.css')));
	...
	if (is_front_page()) {
		...
		wp_enqueue_script('swiper-bundle', 'https://cdn.jsdelivr.net/npm/swiper@8/swiper-bundle.min.js', '', '', true);
		wp_enqueue_script('gsap', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/gsap.min.js', '', '', true);
		wp_enqueue_script('scrolltrigger', 'https://cdnjs.cloudflare.com/ajax/libs/gsap/3.12.5/ScrollTrigger.min.js', '', '', true);
	}
}
...
function block_editor_css()
{
	...
	add_editor_style('/assets/css/styles.css'); //サイトオリジナル
